...
def main() -> None:
    ...
    selectors = {
        "front_baseline_cfg05": select_front_baseline,
        "front_narrow_cfg05": select_front_narrow,
    }
    ...
    out_path = args.run_summary.parent / "front_best_combination.json"
